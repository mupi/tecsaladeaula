...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field education_levels on 'TimtecUserSchool'
        m2m_table_name = db.shorten_name(u'accounts_timtecuserschool_education_levels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timtecuserschool', models.ForeignKey(orm[u'accounts.timtecuserschool'], null=False)),
            ('educationlevel', models.ForeignKey(orm[u'accounts.educationlevel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['timtecuserschool_id', 'educationlevel_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field education_levels on 'TimtecUserSchool'
        db.delete_table(db.shorten_name(u'accounts_timtecuserschool_education_levels'))
