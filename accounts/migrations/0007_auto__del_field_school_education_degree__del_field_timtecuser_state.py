...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'School.education_degree'
        db.delete_column(u'accounts_school', 'education_degree')
    ...
    def backwards(self, orm):
        # Adding field 'School.education_degree'
        db.add_column(u'accounts_school', 'education_degree',
