...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimtecUser.username'
        db.alter_column(u'accounts_timtecuser', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'TimtecUser.username'
        db.alter_column(u'accounts_timtecuser', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
