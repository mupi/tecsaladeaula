...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field education_levels on 'TimtecUser'
        m2m_table_name = db.shorten_name(u'accounts_timtecuser_education_levels')
        ...
        db.create_unique(m2m_table_name, ['timtecuser_id', 'educationlevel_id'])


    def backwards(self, orm):
        # Removing M2M table for field education_levels on 'TimtecUser'
        db.delete_table(db.shorten_name(u'accounts_timtecuser_education_levels'))
