...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimtecUser.first_name'
        db.alter_column(u'accounts_timtecuser', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'TimtecUser.last_name'
        db.alter_column(u'accounts_timtecuser', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'TimtecUser.first_name'
        db.alter_column(u'accounts_timtecuser', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'TimtecUser.last_name'
        db.alter_column(u'accounts_timtecuser', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))
