...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimtecUser.cpf'
        db.add_column(u'accounts_timtecuser', 'cpf',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)

        # Adding field 'TimtecUser.rg'
        db.add_column(u'accounts_timtecuser', 'rg',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)

        # Adding field 'TimtecUser.phone'
        db.add_column(u'accounts_timtecuser', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimtecUser.cpf'
        db.delete_column(u'accounts_timtecuser', 'cpf')

        # Deleting field 'TimtecUser.rg'
        db.delete_column(u'accounts_timtecuser', 'rg')

        # Deleting field 'TimtecUser.phone'
        db.delete_column(u'accounts_timtecuser', 'phone')
    ...
    models = {
        ...
        u'accounts.timtecuser': {
            ...
            'cpf': ('django.db.models.fields.CharField', [], {'max_length': '14', 'null': 'True'}),
            ...
            'rg': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True'}),
