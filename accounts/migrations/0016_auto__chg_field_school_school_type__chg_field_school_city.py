...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_school', 'school_type', self.gf('django.db.models.fields.CharField')(default='PR', max_length=2))

        # Changing field 'School.city'
        db.alter_column(u'accounts_school', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.City']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'School.city'
        db.alter_column(u'accounts_school', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.City'], null=True))
    ...
    models = {
        ...
        u'accounts.school': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.City']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
