...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimtecUser.phone'
        db.alter_column(u'accounts_timtecuser', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'TimtecUser.phone'
        db.alter_column(u'accounts_timtecuser', 'phone', self.gf('django.db.models.fields.CharField')(max_length=14, null=True))
