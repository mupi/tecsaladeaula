...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_discipline', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Discipline.name'
        db.alter_column(u'accounts_discipline', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, primary_key=True))
    ...
    models = {
        ...
        u'accounts.timtecuser': {
            ...
            'jobs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['accounts.Job']", 'null': 'True', 'blank': 'True'}),
