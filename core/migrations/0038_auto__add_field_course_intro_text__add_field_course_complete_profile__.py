...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_course', 'intro_text',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.complete_profile'
        db.add_column(u'core_course', 'complete_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Course.left_tag'
        db.alter_column(u'core_course', 'left_tag', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Course.modal_text'
        db.alter_column(u'core_course', 'modal_text', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Course.right_tag'
        db.alter_column(u'core_course', 'right_tag', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'Course.intro_text'
        db.delete_column(u'core_course', 'intro_text')

        # Deleting field 'Course.complete_profile'
        db.delete_column(u'core_course', 'complete_profile')


        # Changing field 'Course.left_tag'
        db.alter_column(u'core_course', 'left_tag', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Course.modal_text'
        db.alter_column(u'core_course', 'modal_text', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Course.right_tag'
        db.alter_column(u'core_course', 'right_tag', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
