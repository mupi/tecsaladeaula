...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.left_tag'
        db.add_column(u'core_course', 'left_tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Course.right_tag'
        db.add_column(u'core_course', 'right_tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Course.left_tag'
        db.delete_column(u'core_course', 'left_tag')

        # Deleting field 'Course.right_tag'
        db.delete_column(u'core_course', 'right_tag')
    ...
    models = {
        ...
        u'core.course': {
            ...
            'left_tag': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'right_tag': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
