...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseProfessor.biography'
        db.alter_column(u'core_courseprofessor', 'biography', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Course.private'
        db.add_column(u'core_course', 'private',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CourseProfessor.biography'
        db.alter_column(u'core_courseprofessor', 'biography', self.gf('django.db.models.fields.TextField')(default=''))
        # Deleting field 'Course.private'
        db.delete_column(u'core_course', 'private')
