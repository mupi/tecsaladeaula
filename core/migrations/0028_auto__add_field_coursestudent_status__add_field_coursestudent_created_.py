...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseStudent.status'
        db.add_column(u'core_coursestudent', 'status',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Adding field 'CourseStudent.created_at'
        db.add_column(u'core_coursestudent', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseStudent.status'
        db.delete_column(u'core_coursestudent', 'status')

        # Deleting field 'CourseStudent.created_at'
        db.delete_column(u'core_coursestudent', 'created_at')
