...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.payment_url'
        db.alter_column(u'core_course', 'payment_url', self.gf('django.db.models.fields.TextField')(max_length=50, null=True, blank=True))

    def backwards(self, orm):

        # Changing field 'Course.payment_url'
        db.alter_column(u'core_course', 'payment_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))
