...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.tag_left'
        db.add_column(u'core_course', 'tag_left',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Course.tag_right'
        db.add_column(u'core_course', 'tag_right',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Course.subscribe_date_limit'
        db.add_column(u'core_course', 'subscribe_date_limit',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.modal_text'
        db.add_column(u'core_course', 'modal_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.tag_left'
        db.delete_column(u'core_course', 'tag_left')

        # Deleting field 'Course.tag_right'
        db.delete_column(u'core_course', 'tag_right')

        # Deleting field 'Course.subscribe_date_limit'
        db.delete_column(u'core_course', 'subscribe_date_limit')

        # Deleting field 'Course.modal_text'
        db.delete_column(u'core_course', 'modal_text')
    ...
    models = {
        ...
        u'core.course': {
            ...
            'modal_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'tag_left': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'tag_right': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
