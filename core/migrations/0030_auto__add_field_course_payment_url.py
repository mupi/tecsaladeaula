...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.payment_url'
        db.add_column(u'core_course', 'payment_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.payment_url'
        db.delete_column(u'core_course', 'payment_url')
    ...
    models = {
        ...
        u'core.course': {
            ...
            'payment_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
