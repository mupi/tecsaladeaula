...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.tuition'
        db.add_column(u'core_course', 'tuition',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=9, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.tuition'
        db.delete_column(u'core_course', 'tuition')
